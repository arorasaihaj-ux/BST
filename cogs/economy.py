...
class Economy(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        try:
            ...
            if new_count % MESSAGES_PER_BST == 0:
                ...
                pool_balance = await self.bot.db.get_economy_pool()
    ...
    async def balance(self, interaction: discord.Interaction, user: discord.Member = None):
        """Public balance check with progress"""
        ...
        try:
            ...
            # Create progress bar
            filled = int(progress_percent / 5)  # 20 segments
    ...
    async def messages(self, interaction: discord.Interaction):
        """Show detailed message progress"""
        try:
            ...
            # Fancy progress bar
            filled = int(progress_percent / 2.5)  # 40 segments
    ...
    async def leaderboard(self, interaction: discord.Interaction):
        ...
        try:
            ...
            if not balances:
                await interaction.response.send_message("No one has BST yet! Start chatting to earn BST.", ephemeral=True)
                return
            ...
            embed.add_field(
                name="📅 Weekly Status",
                value=f"**{weekly_remaining:.1f} BST** remaining this week",
                inline=True
            )
