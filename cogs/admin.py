...
class Admin(commands.Cog):
    ...
    async def mint(self, interaction: discord.Interaction, amount: float):
        ...
        try:
            ...
            embed.add_field(name="💰 New Pool", value=f"**{new_pool:.2f} BST**")
    ...
    async def pool(self, interaction: discord.Interaction):
        ...
        try:
            ...
            embed.add_field(name="💰 Pool", value=f"{pool:.2f} BST", inline=True)
    ...
    async def resetpool(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            ...
            description="This will reset the pool to **0 BST**!\n\n**This removes ALL BST from the pool!**",
            color=0xED4245
        )
    ...
    @app_commands.command(name="addbst", description="Give BST to user (Manager)")
    @app_commands.guilds(discord.Object(id=int(os.getenv('GUILD_ID'))))
